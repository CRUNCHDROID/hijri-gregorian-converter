...
class UmmAlquraModule {
    ...
    private static final int MonthMap[] = {19410,
     ...
     */
    private static int Hsub2G(HijriModule.sDate mydate, int mh, int yh) {
        int flag;
        int JD;
        double GJD;
     ...
     */
    private static double HCalendarToJDA(int yh, int mh, int dh) {
        int flag, Dy, m, b;
        int JD;
        double GJD;

        /* estimate JD of the beginning of year */
        JD = (int) HCalendarToJD(yh, 1, 1);
     ...
     */
    private static int DayinYear(int yh, int mh, int dh) {
        int flag, Dy, m, b, DL;
     ...
     * Output:  Year Length
     */
    private static int HYearLength(int yh) {
        int flag, Dy, m, b, YL;
     ...
     * and returns flag found:1 not found:0
     */
    static int G2H(HijriModule.sDate mydate, int dg, int mg, int yg) {
        int yh2, mh2;
        int df;
        int flag = 1;
        int J;
        double GJD, HJD;
        final HijriModule.sDate tmpdate = new HijriModule.sDate();
        final HijriModule.sDate tmpdate2 = new HijriModule.sDate();
        /*int error_fill;*/
        ...
        J = (int) (GCalendarToJD(yg, mg, dg) + 2);
        mydate.weekday = J % 7;
        ...
        HijriModule.fill_datestruct(mydate, mydate.weekday, mg, mydate.month,
                HijriModule.g_day, HijriModule.g_day_short, HijriModule.g_month, HijriModule.g_month_short,
                HijriModule.h_day, HijriModule.h_day_short, HijriModule.h_month, HijriModule.h_month_short,
                null);
     ...
     */
    static int H2G(HijriModule.sDate mydate, int dh, int mh, int yh) {
        int found, yh1, mh1;
        /*int error_fill;*/
        final HijriModule.sDate tmpdate = new HijriModule.sDate();
        ...
        /* Fill-in the structure with various nicities a user might need */
        HijriModule.fill_datestruct(mydate, mydate.weekday, mh, mydate.month,
                HijriModule.h_day, HijriModule.h_day_short, HijriModule.h_month, HijriModule.h_month_short,
                HijriModule.g_day, HijriModule.g_day_short, HijriModule.g_month, HijriModule.g_month_short,
                null);
     ...
     */
    private static double JDToGCalendar(double JD, HijriModule.sDate mydate) {
        double A, B, F;
        int alpha, C, E;
        int D, Z;
     ...
     */
    private static void GDateAjust(HijriModule.sDate mydate) {
        int dys;
     ...
     * Dy=6 Saturday
     */
    private static int DayWeek(int JulianD) {
        int Dy;
     ...
     */
    private static void JDToHCalendar(double JD, HijriModule.sDate mydate) {
     ...
     * Output : Hijrah date: year:yh, month:mh, day:dh
     */
    private static int[] JDToHACalendar(double JD) {
        int df;
        double HJD;
        final HijriModule.sDate tmpdate = new HijriModule.sDate();
         ...
         */
        int yh = tmpdate.year;
        int mh = tmpdate.month;
        int dh = tmpdate.day;
        return new int[]{yh, mh, dh};
    }
     ...
     */
    private static int IsValid(int yh, int mh, int dh) {
        int valid = 1;
